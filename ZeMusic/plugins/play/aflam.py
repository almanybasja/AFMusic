"""
        ...
        [InlineKeyboardButton("「𝚂𝙾𝚞𝚁𝚂 ", url=f"https://t.me/St7art")],
"""
...
async def aflamAR(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("「𝚂𝙾𝚞𝚁𝚂 」ま", url=f"https://t.me/St7art")],
...
async def action(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝐇𝐎𝐌", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」ま", url=f"https://t.me/UI_VM")],
